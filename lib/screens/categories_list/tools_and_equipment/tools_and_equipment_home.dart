...
class ToolsAndEquipment extends StatelessWidget {
  static String routeName = '/tools_and_equipment_home';
          ...
          itemBuilder: (context, int index) {
            return Column(
              ...
              children: [
                ...
                ListViewWidget(
                  iPhoneItem: toolsAndEquipment[index],
                  categoryName: toolsAndEquipment,
                ),
              ],
            );
          }),
