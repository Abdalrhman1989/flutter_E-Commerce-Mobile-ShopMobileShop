...
class IPhoneBatteriesHome extends StatelessWidget {
  static String routeName = '/iphone_batteries_home';
          ...
          itemBuilder: (context, int index) {
            return Column(
              ...
              children: [
                ...
                ListViewWidget(
                  iPhoneItem: iphoneBatteries[index],
                  categoryName: iphoneBatteries,
                ),
              ],
            );
          }),
