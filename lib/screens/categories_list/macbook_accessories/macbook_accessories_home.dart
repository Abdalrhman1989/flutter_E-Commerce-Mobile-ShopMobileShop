...
class MacbookAccessoriesHome extends StatelessWidget {
  static String routeName = '/macbook_accessories_home';
          ...
          itemBuilder: (context, int index) {
            return Column(
              ...
              children: [
                ...
                ListViewWidget(
                  iPhoneItem: macbook_accessories[index],
                  categoryName: macbook_accessories,
                ),
              ],
            );
          }),
