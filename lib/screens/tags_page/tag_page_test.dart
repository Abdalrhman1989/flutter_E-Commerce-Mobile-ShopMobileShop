...
class TagsPageTest extends Body {
  ...
  @override
  _TagsPageTestState createState() => _TagsPageTestState();
}

class _TagsPageTestState extends BodyState<TagsPageTest> {
  ...
  onSearchChange() {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () {
      productList.resetStreams();
      productList.setLoadingState(LoadMoreStatus.INITIAL);
      productList.fetchProductsByTag(
        _pageNumber,
        this.widget.tagName,
          ...
          Container(
            ...
            child: PopupMenuButton(
              onSelected: (sortBy) {
                ...
                productList.fetchProductsByTag(
                    _pageNumber, this.widget.tagName);
              },
